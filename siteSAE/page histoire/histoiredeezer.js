...
$(function(){
  $('.menu').mouseenter(function(){
    $('.md').addClass('show');
    $('.boutonmenuprincipal').addClass('colorb');
    $('.menu').addClass('deroulant');
    $('dropdown-child').removeClass('tests');
  ...
  $('.menu').mouseleave(function(){
    $('.md').removeClass('show');
    $('.boutonmenuprincipal').removeClass('colorb');
    $('.menu').removeClass('deroulant');
    $('dropdown-child').addClass('tests');
